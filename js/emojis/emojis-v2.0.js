    ...
    try {
        ...
        function getHELP() {
            ...
            loading.innerHTML = `<p class='mytxt'>
                        ...
                        "<span class='emojitxt'>😎</span>svg" <br>
                        "<span class='emojitxt'>😎</span>png" <br>
                        "<span class='emojitxt'>😎</span>gif" <br>
                        "<span class='emojitxt'>😎</span>webp" <br>
                        "<span class='emojitxt'>😎</span>Apple" <br>
                        "<span class='emojitxt'>😎</span>Twitter" <br>
                        "<span class='emojitxt'>😎</span>Facebook" <br>
                        "<span class='emojitxt'>😎</span>txt" <br>
                        "<span class='emojitxt'>😎</span>Unicode" <br>
                        "<span class='emojitxt'>😎</span>details" <br>
                        'allGoogle' <br>
                        'allGooglesvg' <br>
                         'allTwitter' <br>
                         'allFacebook' <br>
        ...
        function findEmojiforUnicode (u) {
            ...
            loading.innerHTML = ''
            emojiList.innerHTML = `Emoji for your unicode (${u}) is <br><span class='bigtxt'>${(x)}</span>`
        }
